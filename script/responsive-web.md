...
<br>
<b>반응형 웹</b>
반응형 웹은 해상도에 따라서 반응을 하는 웹 방식을 의미한다. <br>
일반적으로 PC 버전과 스마트폰 버전의 홈페이지를 분리하여 만들기도 한다. <br>
이때 모바일(스마트폰)에 최적화된 웹을 '모바일 웹'이라고 한다. <br>
...
웹에서 동적인 그래픽을 만들기 위해서는 자바스크립트 사용이 불가피하다. <br>
동적인 그래픽을 만들 수 있는 다양한 라이브러리들을 가지고 있는 자바스크립트는 웹에 특화된 기술이기 때문에 운영체제나 플랫폼에 상관없이 잘 작동되고 확장성도 높다. <br>
