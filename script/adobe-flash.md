...
<br>
<i>
  스티브 잡스는 세상을 뜰 때까지 플래시를 싫어했다고 한다. <br>
  초기 어도비는 매킨토시를 밀고 있었고 이때는 양자의 관계가 좋았지만 마이크로소프트가 윈도우95를 출시한 이후로 조금씩 옮겨가는 모습을 보이면서 애프롸 사이가 나   빠졌다. <br>
  플래시는 원래 어도비 회사의 제품이 아니었디만 어도비가 인수하고 나서부터 애플 지원 정책에 아예 빠져버려 자연히 배척하게 되었다. <br>
  결국 사업상의 마찰이라고 보는 것이 적절하다. <br>
  iOS는 플래시를 아예 지원하기 않으며, macOS에서는 돌아가기는하나 최적화가 잘 되어있지 않고 상당히 불안정하다. <br>
  </i>
<br>
...
또, 진입 장벽이 낮은 플래시의 특징 탓에 역으로 효율성이 떨어지는 더럽게 만든 코드가 많다는 점과 초보 개발자들은 잘 모르는 wmode 등이 있다. <br>
<br>
